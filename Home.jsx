...
export default function Home() {
  ...
  // Updated Mock Data array with requested prices
  const featuredProducts = [
    {
      ...
      category: 'Shoes',
      price: 900,
      image: '/assets/images/wholecut_oxford.png',
      ...
      specs: ['Single Piece Leather Cut', 'Closed Channel Goodyear Welt', 'Violin-back Beveled Waist', 'Hand-Painted Oak Bark Sole']
    },
    {
      id: 'travelbag',
      ...
      category: 'Travel Bag',
      price: 1800,
      image: '/assets/images/leather_travel_bag.png',
      ...
      specs: ['Full-Grain Vegetable Leather', 'YKK Excella Solid Brass Zippers', 'Removable Padded Shoulder Strap', 'Reinforced Structured Base']
    },
    {
      id: 'handbag',
      ...
      price: 1500,
      image: '/assets/images/leather_ladies_handbag.png',
      ...
      specs: ['Hand-Stretched Calfskin', 'Premium Whiskey Gold Hardware', 'Magnetic Flap Closure', 'Double Compartment Design']
    }
  ];
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <ul className="space-y-3 pl-2 border-l border-[#B07D4F]/10">
                  <li><a href="#collection" onClick={() => setIsMenuOpen(false)} className="text-sm text-[#F9F9F9]/75 hover:text-[#B07D4F] transition-colors block">School Bag</a></li>
                  <li><a href="#collection" onClick={() => setIsMenuOpen(false)} className="text-sm text-[#F9F9F9]/75 hover:text-[#B07D4F] transition-colors block">College Bag</a></li>
                  <li><a href="#collection" onClick={() => setIsMenuOpen(false)} className="text-sm text-[#F9F9F9]/75 hover:text-[#B07D4F] transition-colors block">Ladies Hand Bag</a></li>
                  <li><a href="#collection" onClick={() => setIsMenuOpen(false)} className="text-sm text-[#F9F9F9]/75 hover:text-[#B07D4F] transition-colors block">Travel Bag</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 pl-2 border-l border-[#B07D4F]/10">
                  <li><a href="#collection" onClick={() => setIsMenuOpen(false)} className="text-sm text-[#F9F9F9]/75 hover:text-[#B07D4F] transition-colors block">Ladies Hand Purse</a></li>
                  <li><a href="#collection" onClick={() => setIsMenuOpen(false)} className="text-sm text-[#F9F9F9]/75 hover:text-[#B07D4F] transition-colors block">Men's Wallet</a></li>
                  <li><a href="#collection" onClick={() => setIsMenuOpen(false)} className="text-sm text-[#F9F9F9]/75 hover:text-[#B07D4F] transition-colors block">Men's Belt</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 pl-2 border-l border-[#B07D4F]/10">
                  <li><a href="#collection" onClick={() => setIsMenuOpen(false)} className="text-sm text-[#F9F9F9]/75 hover:text-[#B07D4F] transition-colors block">Shoes</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-y-20 md:gap-x-12 lg:gap-x-16 items-start">
            ...
            <div 
              ...
              onClick={() => setSelectedShoe(featuredProducts[0])}
            >
              <div className="relative overflow-hidden bg-[#141414] border border-[#F9F9F9]/5 aspect-[4/5] whiskey-glow-hover transition-all duration-700 ease-out">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 translate-y-full group-hover:translate-y-0 transition-transform duration-[700ms] [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] backdrop-blur-md bg-black/40 border-t border-[#B07D4F]/20 flex flex-col justify-end">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <p className="text-[10px] uppercase tracking-[0.3em] text-[#B07D4F] mb-1">{featuredProducts[0].category}</p>
                      <h3 className="text-xl md:text-2xl font-serif text-[#F9F9F9]">{featuredProducts[0].name}</h3>
                    </div>
                    <span className="text-lg font-serif text-[#B07D4F] font-semibold">₹{featuredProducts[0].price.toLocaleString('en-IN')}</span>
                  </div>
                  <p className="text-sm text-[#F9F9F9]/75 mb-6 font-light leading-relaxed">
                    {featuredProducts[0].description}
                  </p>
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
                      setSelectedShoe(featuredProducts[0]);
                    }}
                    className="w-full py-3 bg-[#B07D4F] text-[#0A0A0A] hover:bg-[#F9F9F9] hover:text-[#0A0A0A] transition-colors duration-300 text-[10px] tracking-[0.2em] uppercase font-semibold"
                  >
                    Examine Anatomy
                  </button>
                </div>
              ...
              <div className="mt-6 flex justify-between items-center px-2">
                <div>
                  <h4 className="font-serif text-2xl text-[#F9F9F9]">{featuredProducts[0].name}</h4>
                  <p className="text-[11px] text-[#F9F9F9]/70 tracking-wider mt-1">{featuredProducts[0].category}</p>
                </div>
                <span className="font-serif text-xl text-[#B07D4F]">₹{featuredProducts[0].price.toLocaleString('en-IN')}</span>
              </div>
            </div>
            ...
            <div 
              ...
              onClick={() => setSelectedShoe(featuredProducts[1])}
            >
              <div className="relative overflow-hidden bg-[#141414] border border-[#F9F9F9]/5 aspect-[4/5] whiskey-glow-hover transition-all duration-700 ease-out">
                {/* Product Image */}
                <div className="w-full h-full p-8 flex items-center justify-center transition-transform duration-[700ms] [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] group-hover:scale-[1.08]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 translate-y-full group-hover:translate-y-0 transition-transform duration-[700ms] [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] backdrop-blur-md bg-black/40 border-t border-[#B07D4F]/20 flex flex-col justify-end">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <p className="text-[10px] uppercase tracking-[0.3em] text-[#B07D4F] mb-1">{featuredProducts[1].category}</p>
                      <h3 className="text-xl md:text-2xl font-serif text-[#F9F9F9]">{featuredProducts[1].name}</h3>
                    </div>
                    <span className="text-lg font-serif text-[#B07D4F] font-semibold">₹{featuredProducts[1].price.toLocaleString('en-IN')}</span>
                  </div>
                  <p className="text-sm text-[#F9F9F9]/75 mb-6 font-light leading-relaxed">
                  ...
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
                      setSelectedShoe(featuredProducts[1]);
                    }}
                    className="w-full py-3 bg-[#B07D4F] text-[#0A0A0A] hover:bg-[#F9F9F9] hover:text-[#0A0A0A] transition-colors duration-300 text-[10px] tracking-[0.2em] uppercase font-semibold"
                  >
                    Examine Anatomy
              ...
              <div className="mt-6 flex justify-between items-center px-2">
                <div>
                  <h4 className="font-serif text-2xl text-[#F9F9F9]">{featuredProducts[1].name}</h4>
                  <p className="text-[11px] text-[#F9F9F9]/70 tracking-wider mt-1">{featuredProducts[1].category}</p>
                </div>
                <span className="font-serif text-xl text-[#B07D4F]">₹{featuredProducts[1].price.toLocaleString('en-IN')}</span>
              </div>
            </div>
            ...
            <div 
              ...
              onClick={() => setSelectedShoe(featuredProducts[2])}
            >
              <div className="relative overflow-hidden bg-[#141414] border border-[#F9F9F9]/5 aspect-[16/10] whiskey-glow-hover transition-all duration-700 ease-out">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 translate-y-full group-hover:translate-y-0 transition-transform duration-[700ms] [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] backdrop-blur-md bg-black/40 border-t border-[#B07D4F]/20 flex flex-col justify-end">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <p className="text-[10px] uppercase tracking-[0.3em] text-[#B07D4F] mb-1">{featuredProducts[2].category}</p>
                      <h3 className="text-xl md:text-2xl font-serif text-[#F9F9F9]">{featuredProducts[2].name}</h3>
                    </div>
                    <span className="text-lg font-serif text-[#B07D4F] font-semibold">₹{featuredProducts[2].price.toLocaleString('en-IN')}</span>
                  </div>
                  <p className="text-sm text-[#F9F9F9]/75 mb-6 font-light leading-relaxed">
                  ...
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
                      setSelectedShoe(featuredProducts[2]);
                    }}
                    className="w-full py-3 bg-[#B07D4F] text-[#0A0A0A] hover:bg-[#F9F9F9] hover:text-[#0A0A0A] transition-colors duration-300 text-[10px] tracking-[0.2em] uppercase font-semibold"
                  >
                    Examine Anatomy
              ...
              <div className="mt-6 flex justify-between items-center px-2">
                <div>
                  <h4 className="font-serif text-2xl text-[#F9F9F9]">{featuredProducts[2].name}</h4>
                  <p className="text-[11px] text-[#F9F9F9]/70 tracking-wider mt-1">{featuredProducts[2].category}</p>
                </div>
                <span className="font-serif text-xl text-[#B07D4F]">₹{featuredProducts[2].price.toLocaleString('en-IN')}</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 py-20">
            ...
            <div className="md:col-span-2 md:col-start-6">
              ...
              <ul className="space-y-4 text-xs text-[#F9F9F9]/60">
                <li><a href="#collection" className="hover:text-[#B07D4F] transition-colors duration-300">School Bag</a></li>
                <li><a href="#collection" className="hover:text-[#B07D4F] transition-colors duration-300">College Bag</a></li>
                <li><a href="#collection" className="hover:text-[#B07D4F] transition-colors duration-300">Ladies Hand Bag</a></li>
                <li><a href="#collection" className="hover:text-[#B07D4F] transition-colors duration-300">Travel Bag</a></li>
              </ul>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <ul className="space-y-4 text-xs text-[#F9F9F9]/60 font-light">
                <li><a href="#collection" className="hover:text-[#B07D4F] transition-colors duration-300">Ladies Hand Purse</a></li>
                <li><a href="#collection" className="hover:text-[#B07D4F] transition-colors duration-300">Men's Wallet</a></li>
                <li><a href="#collection" className="hover:text-[#B07D4F] transition-colors duration-300">Men's Belt</a></li>
              </ul>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <ul className="space-y-4 text-xs text-[#F9F9F9]/60 font-light">
                <li><a href="#collection" className="hover:text-[#B07D4F] transition-colors duration-300">Shoes</a></li>
              </ul>
            </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6 bg-black/90 backdrop-blur-lg transition-opacity duration-500">
          <div className="relative w-full max-w-4xl bg-[#141414] border border-[#B07D4F]/30 overflow-hidden shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12">
              ...
              <div className="md:col-span-6 bg-[#0A0A0A] flex items-center justify-center p-8 border-b md:border-b-0 md:border-r border-[#F9F9F9]/5 min-h-[300px]">
                <img 
                  src={selectedShoe.image} 
                  alt={selectedShoe.name} 
                  className="max-h-[300px] object-contain drop-shadow-[0_25px_40px_rgba(0,0,0,0.8)]"
                />
              </div>
              ...
              <div className="md:col-span-6 p-8 md:p-12 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-3xl font-serif text-[#F9F9F9] mt-2 mb-4">{selectedShoe.name}</h3>
                  <p className="text-xs text-[#F9F9F9]/70 tracking-wider mb-6">{selectedShoe.category}</p>
                  
                  <p className="text-sm text-[#F9F9F9]/80 font-light leading-relaxed mb-8">
                ...
                <div className="flex items-center justify-between border-t border-[#F9F9F9]/5 pt-6 mt-6">
                  <div>
                    ...
                    <p className="text-xl font-serif text-[#B07D4F] font-semibold mt-1">₹{selectedShoe.price.toLocaleString('en-IN')}</p>
                  </div>
                  
                  <a 
                    href="tel:8903553679"
                    className="px-8 py-4 bg-[#B07D4F] text-[#0A0A0A] hover:bg-[#F9F9F9] hover:text-[#0A0A0A] font-semibold text-xs tracking-[0.2em] uppercase transition-colors duration-300 text-center"
                  >
                    Call & Order
                  </a>
                </div>
